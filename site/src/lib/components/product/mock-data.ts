...
export const transcript: TranscriptSegment[] = [
	{ speaker: 'Speaker 1', time: '00:02', text: "Let's lock the launch date before we get into scope." },
	{ speaker: 'Speaker 2', time: '00:09', text: 'The 14th works if onboarding is ready by then.' },
	{ speaker: 'Speaker 1', time: '00:21', text: 'Onboarding is the risk. Can we cut the import step for v1?' },
	{ speaker: 'Speaker 2', time: '00:33', text: 'Yes — ship core capture first, add import the week after.' },
	{ speaker: 'Speaker 1', time: '00:48', text: "Agreed. I'll send the updated timeline today." }
];

export const rawNotes = ['launch date?', 'onboarding not ready', 'cut import for v1?', 'send timeline'];
