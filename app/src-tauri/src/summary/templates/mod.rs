...
//! # Architecture
//!
//! - **Built-in templates**: JSON files in `app/src-tauri/templates/` embedded at compile time
...
//! - macOS: `~/Library/Application Support/muesly/templates/`
//! - Windows: `%APPDATA%\muesly\templates\`
//! - Linux: `~/.config/muesly/templates/`
//!
