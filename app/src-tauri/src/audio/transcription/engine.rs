...
//
// Whisper model initialization and validation logic.

use log::{info, warn};
use std::sync::Arc;
use tauri::{AppHandle, Manager, Runtime};

pub type TranscriptionEngine = Arc<crate::whisper_engine::WhisperEngine>;
...
/// Get or initialize the local Whisper transcription engine.
