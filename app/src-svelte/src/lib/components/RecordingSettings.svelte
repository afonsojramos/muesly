				...
				{#if platform.isMac}
					...
					>
						<div class="min-w-0 flex-1">
							...
							<div class="text-sm text-muted-foreground">
								When a meeting app (Zoom, Teams, Webex) comes to the front, show a floating prompt
								to start recording.
							</div>
						</div>
						<Switch
					...
					>
						<div class="min-w-0 flex-1">
							...
							<div class="text-sm text-muted-foreground">
								When a calendar meeting with attendees starts, show a floating prompt to record it.
								Recording only starts when you accept. Off by default.
							</div>
						</div>
					...
					>
						<div class="min-w-0 flex-1">
							...
							<div class="text-sm text-muted-foreground">
								When you accept the prompt, also open the meeting's video link (Zoom, Meet, Teams)
								in your browser.
							</div>
						</div>
						<Switch
